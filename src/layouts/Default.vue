<template>
  <div
    ...
    :class="theme"
  >
    <header class="border-t-14 border-yellow-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/">
            <g-image src="../../static/dibujo.svg" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/">
            <g-image src="../../static/dibujo_noche.svg" class="w-40" alt="logo" />
          </g-link>
        </div>
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            ...
            >The Program</a>
            <g-link
              v-else-if="$route.path === '/es'"
              to="/es/#programa"
              class="text-copy-primary hover:text-gray-600"
            >Programa</g-link>

            <g-link v-else to="/#program" class="text-copy-primary hover:text-gray-600">The Program</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a
              v-if="$route.path === '/'"
            ...
            <g-link
              ...
              class="text-copy-primary hover:text-gray-600"
            >Registrarse</g-link>
            <g-link v-else to="/#enroll" class="text-copy-primary hover:text-gray-600">Enroll</g-link>
          </li>
          <!-- Soon Add Docs for the lessons and Blog for the Devlog
          <li class="mr-8 mb-6 lg:mb-0">
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <g-link to="/es" class="text-copy-primary hover:text-gray-600">Español</g-link>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-yellow-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Arapy Project {{ new Date().getFullYear() }}. All rights reserved.</div>
          <!--  <div>
